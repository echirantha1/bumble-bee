...
<body>
	...
	<div class="container mt-4">
		<nav class="nav nav-pills flex-column flex-sm-row">
		  ...
		  <a class="flex-sm-fill text-sm-center nav-link active" aria-current="page" href="#">Add Stock</a>
		  <a class="flex-sm-fill text-sm-center nav-link border" href="update-inventory.jsp">Update Stock</a>
		</nav>
	</div>
		...
		<form method="post" action="manage-inventory" class="row align-items-center justify-content-center mt-3">
			...
			<div class="row align-items-center justify-content-center ">
            	<div class="col mb-3 col-md-5">
					...
					<input type="text" id="txtAvailableStock" class="form-control" name="availableStock" />
				</div>
			</div>
			<div class="row align-items-center justify-content-center ">
            	<div class="col mb-3 col-md-5">
					<label for="txtSoldAmount">Sold Amount</label>
					<input type="text" id="txtSoldAmount" class="form-control" name="soldAmount" />
				</div>
			</div>
			...
			<div class="row align-items-center justify-content-center ">
            	<div class="col mb-3 col-md-2">
            		<button type="submit" id="btnsubmit" class="btn btn-success form-control">Add Stock</button>
            	</div>
            </div>
		</form>
	</div>
