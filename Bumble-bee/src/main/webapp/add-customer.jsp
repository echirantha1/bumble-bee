...
<body>
	...
	<div class="container mt-4">
		<nav class="nav nav-pills flex-column flex-sm-row">
		  ...
		  <a class="flex-sm-fill text-sm-center nav-link active" aria-current="page" href="#">Add Customer</a>
		...
		<form method="post" action="manage-customer" class="row align-items-center justify-content-center mt-3">
			<div class="row align-items-center justify-content-center ">
            	<div class="col mb-3 col-md-5">
					...
					<input type="text" id="txtNic" class="form-control" name="nic" onblur="calculateAge()" required />
				</div>
			</div>
			<div class="row align-items-center justify-content-center ">
            	<div class="col mb-3 col-md-5">
					<label for="txtName">Full Name</label>
					<input type="text" id="txtName" class="form-control" name="name" required />
				</div>
			</div>
			<div class="row align-items-center justify-content-center ">
            	<div class="col mb-3 col-md-5">
			...
			<div class="row align-items-center justify-content-center ">
            	<div class="col mb-3 col-md-5">
					...
					<input type="text" id="txtMobile" class="form-control" name="mobile" required />
				</div>
			</div>
			...
			<div class="row align-items-center justify-content-center ">
            	<div class="col mb-3 col-md-2">
            		<button type="submit" id="btnsubmit" class="btn btn-success form-control">Add Customer</button>
            	</div>
            </div>
		</form>
	</div>
