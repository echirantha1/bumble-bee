...
<body>
	...
	<div class="container mt-4">
		<nav class="nav nav-pills flex-column flex-sm-row">
		  ...
		  <a class="flex-sm-fill text-sm-center nav-link active" aria-current="page" href="#">Update Loan</a>
		</nav>
	</div>
	...
	<div class="card col-md-10 mx-auto mt-4">
		<form method="get" action="manage-loan" class="row align-items-center justify-content-center mt-3">
			<div class="row align-items-center justify-content-center">
            	<div class="col mb-3 col-md-5 text-center">
					<label for="txtLoanId">Search Loan ID</label>
					<input type="text" id="txtLoanId" class="form-control" name="loanId" required />
				</div>
			</div>
			<div class="row align-items-center justify-content-center">
				<div class="col mb-3 col-md-5 text-center">
		...
		<form method="post" action="manage-loan" class="row align-items-center justify-content-center mt-3">
			<div class="row align-items-center justify-content-center">
            	<div class="col mb-3 col-md-5">
					...
					<input type="text" id="txtProductId" class="form-control" name="productId" value="${loan.productId}" />
				</div>
			</div>
			<div class="row align-items-center justify-content-center">
            	<div class="col mb-3 col-md-5">
					<label for="txtAmount">Amount</label>
					<input type="text" id="txtAmount" class="form-control" name="amount" value="${loan.amount}" />
				</div>
			</div>
			<div class="row align-items-center justify-content-center">
            	<div class="col mb-3 col-md-5">
					<label for="txtInstallments">Installments</label>
					<input type="text" id="txtInstallments" class="form-control" name="installments" value="${loan.installments}" />
				</div>
			</div>
			<div class="row align-items-center justify-content-center">
            	<div class="col mb-3 col-md-5">
					<label for="txtInterest">Interest</label>
					<input type="text" id="txtInterest" class="form-control" name="interest" value="${loan.interest}" />
				</div>
			</div>
			<div class="row align-items-center justify-content-center">
            	<div class="col mb-3 col-md-5">
					<label for="txtCustomerId">Price</label>
					<input type="text" id="txtCustomerId" class="form-control" name="customerId" value="${loan.customerId}" />
				</div>
			</div>
